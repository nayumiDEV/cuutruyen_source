<template>
  ...
  >
    ...
    <div class="flex items-center px-2 w-full justify-center max-w-[48rem] w-full">
      <router-link
      ...
      <button
        v-else
        class="text-gray-500 rounded h-7 w-7 flex items-center justify-center cursor-default mx-1 flex-none"
        disabled
      >
        <ChevronLeftIcon :size="16" />
      </button>
      <button
        class="h-7 px-1 bg-gray-400 text-sm w-full fine-transition border-gray-400 uppercase relative truncate rounded mx-1 cursor-pointer"
      ...
      <router-link
        ...
        class="text-blue-200 text-xs uppercase font-bold rounded h-7 px-2 bg-blue-700 hover:bg-blue-800 flex items-center justify-center mx-1 flex-none"
      >
