    ...
    <div class="common-container">
      ...
      <div v-else>
        ...
        <div class="flex justify-end">
          <router-link :to="{ name: 'TeamProfileMangasTop', params: { teamId: team.slug } }" class="cursor-pointer flex items-center text-gray-600 hover:text-blue-600 transition text-sm font-bold">
...
export default {
  ...
  methods: {
    ...
    async loadTopMangas () {
      try {
        this.loading = true
        const response = await getTeamMangasTop(this.team.id, 'week', 1, 6)
